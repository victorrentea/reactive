...
import victor.training.reactor.workshop.C3_Errors;
...
public class C3_ErrorsSolved extends C3_Errors {
    private static final Logger log = LoggerFactory.getLogger(C3_ErrorsSolved.class);

    public C3_ErrorsSolved(Dependency dependency) {
        super(dependency);
    }
