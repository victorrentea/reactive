 ...
 *
 */
public class SampleSenderMain {

    private static final String QUEUE = "demo-queue";
    private static final Logger LOGGER = LoggerFactory.getLogger(SampleSenderMain.class);

    private final Sender sender;

    public SampleSenderMain() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SampleSenderMain sender = new SampleSenderMain();
