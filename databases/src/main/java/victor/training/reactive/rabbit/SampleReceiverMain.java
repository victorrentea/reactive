 ...
 *
 */
public class SampleReceiverMain {

    private static final String QUEUE = "demo-queue";
    private static final Logger LOGGER = LoggerFactory.getLogger(SampleReceiverMain.class);

    private final Receiver receiver;
    private final Sender sender;

    public SampleReceiverMain() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SampleReceiverMain receiver = new SampleReceiverMain();
